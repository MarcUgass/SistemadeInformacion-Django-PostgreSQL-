...
def borrarDisparadores(connection):

    cursor = connection.cursor()

    cursor.execute("DROP TRIGGER IF EXISTS ALL ON ALL TABLES;")
...
def crearDisparadores(connection):
    ...
    trigger1 = """CREATE FUNCTION checkMayorDeEdad()
        RETURNS TRIGGER AS
        $$
        BEGIN
        ...
        BEGIN
            ...
            THEN
                ...
                FOR EACH ROW
                EXECUTE FUNCTION checkMayorDeEdad();
            END IF;
        END $$;
        """
    ...
    trigger3 = """CREATE FUNCTION eliminar_tareas_empleado()
        RETURNS TRIGGER AS
        $$
        BEGIN
        ...
        BEGIN
            ...
            THEN
                ...
                FOR EACH ROW
                EXECUTE FUNCTION eliminar_tareas_empleado();
            END IF;
        END $$;
    """
    ...
    trigger4 = """CREATE FUNCTION checkFechaItinerario()
        RETURNS TRIGGER AS
        $$
        BEGIN
        ...
        BEGIN
            ...
            THEN
                ...
                FOR EACH ROW
                EXECUTE FUNCTION checkFechaItinerario();
            END IF;
        END $$;
    """
    ...
    trigger7 = """CREATE FUNCTION eliminar_pago_cliente()
        RETURNS TRIGGER AS
        $$
        BEGIN
        ...
        BEGIN
            ...
            THEN
                ...
                FOR EACH ROW
                EXECUTE FUNCTION eliminar_pago_cliente();
            END IF;
        END $$;
    """
    ...
    trigger9 = """CREATE FUNCTION eliminar_cliente_promocion()
        RETURNS TRIGGER AS
        $$
        BEGIN
        ...
        BEGIN
            ...
            THEN
                ...
                FOR EACH ROW
                EXECUTE FUNCTION eliminar_cliente_promocion();
            END IF;
        END $$;
    """
